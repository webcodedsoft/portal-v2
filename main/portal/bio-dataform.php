...
if(!isset($_GET['app_id']) && !isset($_GET['source']) && !isset($_GET['session']))//!isset($_SESSION["app_id"]) && 
{
    header("Location: validate-admission");

}

$app = $rsch['Application_id'];
if(isset($_GET['session']) != $session && $_GET['app_id'] != $app)//!isset($_SESSION["app_id"]) && 
{
    header("Location: validate-admission");
              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form id="regForm" class="form form-horizontal" action="biodata-form" method="post">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="firstname" readonly="" style="text-transform: capitalize;" value="<?php echo $rsch['FirstName'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="First Name"
                                name="firstname">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="middlename" readonly="" style="text-transform: capitalize;" value="<?php echo $rsch['MiddleName'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Middle Name"
                                name="middlename">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="lastname" readonly="" style="text-transform: capitalize;" value="<?php echo $rsch['LastName'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Last Name"
                                name="lastname">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="email" id="email" readonly="" value="<?php echo $rsch['Email'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Email Address"
                                name="email">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="phonenumber" readonly="" value="<?php echo $rsch['PhoneNumber'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Phone Number"
                                name="phonenumber">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="email" readonly="" value="<?php echo $rsch['Marital'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Marital Status"
                                name="marital">
                              </div>
                            </div>
                          </div>
                         ...
                         <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="gender" readonly="" value="<?php echo $rsch['Gender'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Gender"
                                name="gender">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="date" id="dob" readonly="" value="<?php echo $rsch['Dob'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Date of Birth"
                                name="dob">
                              </div>
                            </div>
                          </div>
                        ...
                        <h4 class="form-section"><i class="la la-eye"></i>Nationality</h4>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="email" readonly="" value="<?php echo $rsch['Country'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Country"
                                name="country">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="email" readonly="" value="<?php echo $rsch['State'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="State"
                                name="state">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="email" readonly="" value="<?php echo $rsch['City'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="City"
                                name="city">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                 <input type="text"  oninput="this.className = ''" readonly="" style="text-transform: capitalize;" value="<?php echo $rsch['Address'];?>" class="border-primary form-control" name="address">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <select onselect="this.className = ''" class="border-primary form-control" readonly="" required id="school" name="school">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <select onselect="this.className = ''" class="border-primary form-control" readonly="" required id="department" name="department">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                 <input type="text" id="userinput3" oninput="this.className = ''" readonly="" value="<?php echo $rsch['Session'];?>" class="form-control border-primary" placeholder="Current Session" name="session">
                              </div>
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="kinfname" style="text-transform: capitalize;"  oninput="this.className = ''" class="form-control border-primary" placeholder="First Name of Next of Kin"
                                name="kinfname">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="kinmname" style="text-transform: capitalize;" oninput="this.className = ''" class="form-control border-primary" placeholder="Middle Name of Next of Kin"
                                name="kinmname">
                              </div>
                            </div>
                          </div>
                         ...
                         <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="kinlname" style="text-transform: capitalize;"  oninput="this.className = ''" class="form-control border-primary" placeholder="Last Name of Kin"
                                name="kinlname">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="kinaddress" style="text-transform: capitalize;" oninput="this.className = ''" class="form-control border-primary" placeholder="Address of Next of Kin"
                                name="kinaddress">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="sponsorname" style="text-transform: capitalize;"  oninput="this.className = ''" class="form-control border-primary" placeholder="Sponsor Surname"
                                name="sponsorfname">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6"> 
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="sponsorothername" style="text-transform: capitalize;" oninput="this.className = ''" class="form-control border-primary" placeholder="Sponsor Other Name"
                         ...
                         <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="sponsornumber" maxlength="11" onkeypress="return OnlyNumber(event)"  oninput="this.className = ''" class="form-control border-primary" placeholder="Sponsor Phone Number"
                                name="sponsorphone">
                              </div>
                            </div> 
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="sponsoraddress" style="text-transform: capitalize;" oninput="this.className = ''" class="form-control border-primary" placeholder="Sponsor Address"
                                name="sponsoraddress">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="declare" style="text-transform: capitalize;"  oninput="this.className = ''" class="form-control border-primary" placeholder="Enter your full name"
                                name="declared">
...
<input type="hidden" id="image"  value="<?php echo $rsch['Passport'];?>" class="form-control border-primary" name="image">
