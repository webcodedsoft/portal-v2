        ...
        <div class="main-menu-content">
          ...
          ?>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">NCE Portal</span></a>
             ...
             <li class=" nav-item"><a href="#"><i class="la la-columns"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Payment</span></a>
              <ul class="menu-content">
                <li><a class="menu-item" href="<?php echo"$base_url";?>/school-bill-checker" data-i18n="nav.page_layouts.1_column">Fee Checker</a>
                </li>
