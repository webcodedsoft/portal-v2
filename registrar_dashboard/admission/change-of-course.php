            ...
            <form method="get" >
              ...
              <div class="row py-2">
                <div class="col-12 text-center">
                  ...
                  <button type="button" onclick="location.href='<?php echo "$base_url";?>/reg-change-of-course'" class="btn btn-warning mr-1">
              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form class="form form-horizontal" method="post" action="reg-admin-admission-edit">
                      <div class="form-body">
