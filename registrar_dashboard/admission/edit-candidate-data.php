...
if(!isset($_GET['app_id']))//!isset($_SESSION["app_id"]) && 
{
    header("Location: ../candidate-list");

}

$_SESSION["admin_app_id"] = $_GET["app_id"];


if (isset($_GET['app_id'])) {

$sqla = "SELECT * FROM  applicationform WHERE Application_id='$_GET[app_id]'";
...
$result = mysqli_num_rows($qsqla);

if ($result < 1) {
  header("Location: ../reg-candidate-list");
}
                    ...
                    if (isset($_SESSION['biocor'])) 
                    {
                      ...
                      <div class="alert bg-success alert-icon-left alert-arrow-left alert-dismissible mb-2"
                        role="alert">
                          ...
                          <strong>Oh snap!</strong> '.$_SESSION["biocor"].'
                        </div>

                    ';
                      
                      unset($_SESSION['biocor']);

                    }

                  
                     ?>
                    <form id="regForm" class="form form-horizontal" action="../reg-admin-admission-edit" method="post">
					...
					<div class="tab">
                      <div class="form-body">
                        <h4 class="form-section"><i class="la la-eye"></i> Personal Data</h4>
                         ...
                         <input type="hidden" id="firstname" style="text-transform: capitalize;" value="<?php echo $_GET['app_id'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="First Name"
                                name="app_id">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="firstname" style="text-transform: capitalize;" value="<?php echo $rsprint['FirstName'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="First Name"
                                name="firstname">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="middlename" style="text-transform: capitalize;" value="<?php echo $rsprint['MiddleName'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Middle Name"
                                name="middlename">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="lastname" style="text-transform: capitalize;" value="<?php echo $rsprint['LastName'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Last Name"
                                name="lastname">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="email" id="email" value="<?php echo $rsprint['Email'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Email Address"
                                name="email">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="userinput3" required="" onkeypress="return OnlyNumber(event)"  value="<?php echo $rsprint['PhoneNumber'];?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Phone Number"
                                name="phonenumber">
                              </div>
                            </div>
                          </div>
						 ...
						 <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <select name="country" required="" onselect="this.className = ''" class="border-primary form-control countries order-alpha include-NG presel-NG" id="countryId">
				...
				<div class="tab">
            	    ...
            	    <div class="form-body">
	                  ...
	                  <div class="card-body col-md-12">
	                    ...
	                    <form action="../reg-admin-admission-edit" class="dropzone dropzone-area" id="dpz-single-file">
    	                  ...
    	                  <div class="row">
    	                   	<div class="card-body col-md-6">
          	                   <label class="col-md-6 label-control" for="userinput1"><b>O'Level Sitting Result </b><span class="danger">*</span></label>
          	                    <form action="../reg-admin-admission-edit" class="dropzone dropzone-area" id="dpz-multiple-files">
				...
				if ($rsprint['JambOption'] == 'Jamb') {
					?>
    	                  ...
    	                  <label class="col-md-6 label-control" for="userinput1"><b>Jamb Result</b><span class="danger">*</span></label>
    	                   <form action="../reg-admin-admission-edit" class="dropzone dropzone-area" id="dpz-file-limits">
