                    ...
                    <form id="regForm" class="form form-horizontal" action="../admin-admission-edit" method="post">
                      ...
                      <div class="tab">
                        <div class="form-body">
                          ...
                          <input type="hidden" id="firstname" style="text-transform: capitalize;" value="<?php echo $_GET['app_id']; ?>" oninput="this.className = ''" class="form-control border-primary" placeholder="First Name" name="app_id">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                  <input type="text" id="userinput3" required="" onkeypress="return OnlyNumber(event)" value="<?php echo $rsprint['PhoneNumber']; ?>" oninput="this.className = ''" class="form-control border-primary" placeholder="Phone Number" name="phonenumber">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                 <label class="col-md-3 label-control" for="userinput3">Session<span class="danger">*</span></label>
                                <div class="col-md-9">
