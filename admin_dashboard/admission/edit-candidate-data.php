                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    ';
                     ...
                     ?>
                    <form id="regForm" class="form form-horizontal" action="../admin-admission-edit" method="post">
				...
				<div class="tab">
            	    ...
            	    <div class="form-body">
	                  ...
	                  <div class="card-body col-md-12">
	                    ...
	                    <form action="../admin-admission-edit" class="dropzone dropzone-area" id="dpz-single-file">
    	                  ...
    	                  <div class="row">
    	                   	<div class="card-body col-md-6">
          	                   <label class="col-md-6 label-control" for="userinput1"><b>O'Level Sitting Result </b><span class="danger">*</span></label>
          	                    <form action="../admin-admission-edit" class="dropzone dropzone-area" id="dpz-multiple-files">
				...
				if ($rsprint['JambOption'] == 'Jamb') {
					?>
    	                  ...
    	                  <label class="col-md-6 label-control" for="userinput1"><b>Jamb Result</b><span class="danger">*</span></label>
    	                   <form action="../admin-admission-edit" class="dropzone dropzone-area" id="dpz-file-limits">
