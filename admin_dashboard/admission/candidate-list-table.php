...
?>                       
                        <tr>
                         ...
                         <td><div class="row">
                            <div class="col-md-6">
                           <a href="deleting?accept=<?php echo $row['Application_id'];?>" class="btn btn-primary btn-round"> Accept</a></div>
                            <br/>
                           <div class="col-md-6">
                           <a href="deleting?unaccept=<?php echo $row['Application_id'];?>" class="btn btn-danger btn-round">Unaccept</a></div>
                         </div> </td>

  
                         <td>
                          <div class="row">
                            <div class="col-md-6"><a href="edit-candidate-data/<?php echo $row['Application_id'];?>" class="btn btn-info btn-round"> Edit</a></div>

                             <div class="col-md-6"><a href="preview-results?app_id=<?php echo $row['Application_id'];?>" class="btn btn-success btn-round"> View Results</a></div>

                          </td>


                         <td><a href="deleting?can_del=<?php echo $row['Application_id'];?>" class="btn btn-danger btn-round"> Delete</a></td>
